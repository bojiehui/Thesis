...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[Second 10 minutes]{\label{fig:16_MRHOF_line_10_icmp1}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/line/dist10_montecarlo_contour_sent_ICMP_1.pdf}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[First 10 minutes]{\label{fig:16_MRHOF_line_50_icmp0}
      \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/line/dist50_montecarlo_contour_sent_ICMP_0.pdf}}
    \subfloat[Second 10 minutes]{\label{fig:16_MRHOF_line_50_icmp0}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/line/dist50_montecarlo_contour_sent_ICMP_1.pdf}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[First 10 minutes]{\label{fig:16_MRHOF_line_100_icmp0}
      \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/line/dist100_montecarlo_contour_sent_ICMP_0}}
    \subfloat[Second 10 minutes]{\label{fig:16_MRHOF_line_100_icmp1}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/line/dist100_montecarlo_contour_sent_ICMP_1}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[First 10 minutes]{\label{fig:9_MRHOF_grid_10_icmp0}
      \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/9/MRHOF/grid/dist10_montecarlo_contour_sent_ICMP_0.pdf}}
    \subfloat[Second 10 minutes]{\label{fig:9_MRHOF_grid_10_icmp1}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/9/MRHOF/grid/dist10_montecarlo_contour_sent_ICMP_1.pdf}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[First 10 minutes]{\label{fig:9_MRHOF_grid_50_icmp0}
      \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/9/MRHOF/grid/dist50_montecarlo_contour_sent_ICMP_0.pdf}}
    \subfloat[Second 10 minutes]{\label{fig:9_MRHOF_grid_50_icmp0}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/9/MRHOF/grid/dist50_montecarlo_contour_sent_ICMP_1.pdf}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[First 10 minutes]{\label{fig:9_MRHOF_grid_100_icmp0}
      \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/9/MRHOF/grid/dist100_montecarlo_contour_sent_ICMP_0}}
    \subfloat[Second 10 minutes]{\label{fig:9_MRHOF_grid_100_icmp1}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/9/MRHOF/grid/dist100_montecarlo_contour_sent_ICMP_1}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[Second 10 minutes]{\label{fig:16_MRHOF_grid_10_icmp1}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/grid/dist10_montecarlo_contour_sent_ICMP_1.pdf}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[First 10 minutes]{\label{fig:16_MRHOF_grid_50_icmp0}
      \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/grid/dist50_montecarlo_contour_sent_ICMP_0.pdf}}
    \subfloat[Second 10 minutes]{\label{fig:16_MRHOF_grid_50_icmp0}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/grid/dist50_montecarlo_contour_sent_ICMP_1.pdf}}
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \subfloat[First 10 minutes]{\label{fig:16_MRHOF_grid_100_icmp0}
      \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/grid/dist100_montecarlo_contour_sent_ICMP_0}}
    \subfloat[Second 10 minutes]{\label{fig:16_MRHOF_grid_100_icmp1}
       \includegraphics[trim=2cm 0cm 3cm 0cm, clip=true, scale=0.38]{Pics/results/16/MRHOF/grid/dist100_montecarlo_contour_sent_ICMP_1}}
