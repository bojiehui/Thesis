...
\begin{figure}[htbp]
  \begin{center}
    ...
    \subfloat[Typical 6LoWPAN Node]{\label{fig:node stack}
      \includegraphics[scale=0.8]{/home/bo/Documents/Thesis/Final/Template/Pics/Protocol.pdf}}
    \subfloat[6LBR]{\label{fig:6LBR stack}
       \includegraphics[scale=0.8]{/home/bo/Documents/Thesis/Final/Template/Pics/6LBR.pdf}}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \subfloat[First Fragment]{\label{fig:Fragmentation_1}
      \includegraphics[scale=0.8]{/home/bo/Documents/Thesis/Final/Template/Pics/Fragmentation_1.pdf}}\\
    \subfloat[Subsequent Fragment]{\label{fig:Fragmentation_2}
       \includegraphics[scale=0.8]{/home/bo/Documents/Thesis/Final/Template/Pics/Fragmentation_2.pdf}}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \subfloat[DIS-DIO]{\label{fig:seqence_shot_DIO}
      \includegraphics[scale=0.3]{/home/bo/Documents/Thesis/Final/Template/Pics/DIS_DIO.pdf}}\\
    \subfloat[DAO]{\label{fig:seqence_shot_DAO}
       \includegraphics[scale=0.3]{/home/bo/Documents/Thesis/Final/Template/Pics/DAO.pdf}}
